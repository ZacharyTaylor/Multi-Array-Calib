...
warning('This function is outdated and only here for completeness, use GetCamTform3 instead');
%GENCAMTFORM Gets normalized camera transform given two images and K
%--------------------------------------------------------------------------
%   Required Inputs:
%--------------------------------------------------------------------------
%   image- n by m image
