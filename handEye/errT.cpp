...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    //setup outputs
    plhs[0] = mxCreateNumericMatrix(6, n, mxDOUBLE_CLASS, mxREAL);
    double *errOut = mxGetPr(plhs[0]);
    plhs[1] = mxCreateNumericMatrix(6, n, mxDOUBLE_CLASS, mxREAL);
    double *verrOut = mxGetPr(plhs[1]);
    ...
    for(size_t i = 0; i < n; i++){
        ...
        double stB[3];
        double svtB[3];
        double* err = &errOut[6*i];
        double* verr = &verrOut[6*i];
